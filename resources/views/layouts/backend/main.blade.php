...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        {{-- include sidebar --}}
        @include('layouts.backend.sedebar')
    ...
    <script src="{{ asset('template/backend') }}/js/demo/chart-area-demo.js"></script>
    <script src="{{ asset('template/backend') }}/js/demo/chart-pie-demo.js"></script>
